...
class companian object Constants {
    ...
    var RequireName: String = "Full name is requried !";
    var EmailVerify: String = "Check your email pls to verify your account";
    var AuthenticationFailed: String = "Authentication failed.";
